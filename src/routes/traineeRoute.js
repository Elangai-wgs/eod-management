...
Router.route('/createTrainee').post(verifyAuthToken,uploads.single('profilePic'),traineeController.createTrainee);
Router.route('/getTraineeAll').get(verifyAuthToken,traineeController.getTraineeAll);
